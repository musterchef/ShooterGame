...
class AShooterCharacter : public ACharacter
{
	...
	*/
	...
	/** [local] starts jetpack use */
	UFUNCTION(BlueprintCallable, Category = Jetpack)
	void StartJetpack();

	/** [local] stops jetpack use */
	UFUNCTION(BlueprintCallable, Category = Jetpack)
	void StopJetpack();
	...
	*/
	...
	/** player pressed start jetpack action */
	void OnStartJetpack();

	/** player released start jetpack action (or fuel is finished?) */
	void OnStopJetpack();
	...
	*/
	...
	/** get the modifier value for running speed */
	UFUNCTION(BlueprintCallable, Category = Jetpack)
	float GetJetpackSpeedModifier() const;

	/** get the modifier value for running speed */
	UFUNCTION(BlueprintCallable, Category = Jetpack)
	float GetJetpackRefreshRate() const;
...
protected:
	...
	/** current possibility to use the jetpack*/
	...
	float JetpackSpeedModifier;
	UPROPERTY(EditAnywhere, Category = Jetpack)
	float JetpackRefreshRate;
...
public:
	...
	// Current fuel for the Jetpack
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Replicated, Category = Jetpack)
	float Fuel;
